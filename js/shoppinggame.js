...
const dateDiff = (date1, date2) => {
    let milSecs = Math.abs(date1 - date2)
    let days = Math.ceil(milSecs /(60*60*24*1000))
    return days
};
...
function init(data) {
    ...
    const shop = (prodList, tBill, lastProd) => {
        ...
        let productDetails = product.getDetails();
         // Assign the value of productDetails here
    ...
    const exitLost = () => {
        ...
        // Assign calculated value to pointsToReach here
